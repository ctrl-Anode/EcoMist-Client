    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div v-else class="space-y-8">
        ...
        <!-- <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div class="p-6">
            <EcoDeviceData :device-id="selectedDevice.id" />
          </div>
        </div> -->
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 class="text-lg font-semibold mb-4">Current Thresholds</h3>
                <div class="space-y-2">
                  <div v-for="(value, key) in deviceData.thresholds" :key="key" class="flex justify-between">
                    <span class="text-gray-600">{{ formatThresholdKey(key) }}</span>
                    <span class="font-semibold">{{ value }}</span>
                  </div>
                </div>
              </div>
              <div>
                <h3 class="text-lg font-semibold mb-4">Mist Automation</h3>
                <div class="space-y-2">
                  <div class="flex justify-between">
                    <span class="text-gray-600">Auto Mode</span>
                    <span class="font-semibold">{{ deviceData.mist?.auto ? 'Enabled' : 'Disabled' }}</span>
                  </div>
                  <div class="flex justify-between">
                    <span class="text-gray-600">Schedule</span>
                    <span class="font-semibold">{{ deviceData.mist?.schedule || 'N/A' }}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="text-sm font-medium text-gray-600 mb-1">Last Action Result</h3>
                <p class="text-lg font-semibold text-gray-900">{{ deviceData.state?.last_action_result || 'N/A' }}</p>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="text-sm font-medium text-gray-600 mb-1">Reconnect Flag</h3>
                <p class="text-lg font-semibold" :class="deviceData.state?.reconnect ? 'text-yellow-600' : 'text-gray-600'">
                  {{ deviceData.state?.reconnect ? 'Pending' : 'Inactive' }}
                </p>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="text-sm font-medium text-gray-600 mb-1">Disconnect Flag</h3>
                <p class="text-lg font-semibold" :class="deviceData.state?.disconnect ? 'text-red-600' : 'text-gray-600'">
                  {{ deviceData.state?.disconnect ? 'Pending' : 'Inactive' }}
                </p>
              </div>
              <div class="bg-gray-50 rounded-lg p-4">
                <h3 class="text-sm font-medium text-gray-600 mb-1">Simulated Readings</h3>
                <p class="text-lg font-semibold" :class="deviceData.state?.simulated_readings_enabled ? 'text-blue-600' : 'text-gray-600'">
                  {{ deviceData.state?.simulated_readings_enabled ? 'Enabled' : 'Disabled' }}
                </p>
              </div>
            </div>
            <!-- <div class="mt-6">
              <EcoDeviceWifi :device-id="selectedDevice.id" />
            </div> -->
          </div>
        </div>
